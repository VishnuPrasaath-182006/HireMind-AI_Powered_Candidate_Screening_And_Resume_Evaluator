...
class SkillNERExtractor:
    def __init__(self, taxonomy_path: Optional[str] = None):
        ...
        self.aliases = {
            ...
            'data_analytics': 'data analysis',
            'data analysing': 'data analysis',
            'data analyzing': 'data analysis',
    ...
    def normalize_skill(self, skill_name: str) -> str:
        s = skill_name.strip().lower().replace('_', ' ').replace('-', ' ')
        # Standardize UK vs US spellings
        s = s.replace('visualisation', 'visualization')
        s = s.replace('visualise', 'visualize')
        s = s.replace('analysing', 'analyzing')
        s = s.replace('optimisation', 'optimization')
        s = s.replace('customisation', 'customization')
