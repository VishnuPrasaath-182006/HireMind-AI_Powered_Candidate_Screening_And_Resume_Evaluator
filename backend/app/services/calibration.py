...
class CalibrationService:
    def __init__(self):
        ...
        # Pre-trained Logistic Regression parameters from newly replaced trained model:
        # W1 = +2.23680793 (cosine similarity)
        # W2 = +3.87116496 (exact skill match score)
        # W3 = +3.21318671 (relational skill graph score)
        # b  = -4.80455235 (intercept)
        self.weights = [2.23680793, 3.87116496, 3.21318671]
        self.intercept = -4.80455235
    ...
    def get_metrics(self) -> Dict[str, Any]:
        w1 = round(self.weights[0], 2)
        w2 = round(self.weights[1], 2)
        w3 = round(self.weights[2], 2)
        b = round(self.intercept, 2)
        return {
            **self.metrics,
            "weights": self.weights,
            "intercept": self.intercept,
            "model_description": f"Logistic Regression Calibration Model (W1=+{w1}, W2=+{w2}, W3=+{w3}, b={b})"
        }
